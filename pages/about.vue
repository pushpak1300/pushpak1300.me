        ...
        <div class="lg:w-4/6 mx-auto">
          <div class="flex flex-col sm:flex-row mt-6">
            <div class="sm:w-1/3 text-center">
              <div
                class="w-36 h-36 rounded-full inline-flex items-center justify-center text-gray-400"
              >
                <img
              ...
              >
                <h2
                  class="font-medium title-font mt-4 text-gray-900 dark:text-gray-100 text-lg"
                >
                  {{ about.name }}
                </h2>
                <a
